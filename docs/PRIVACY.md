...
| Native task, sidebar-status and Voice helpers | Codex Accessibility controls and sidebar task labels, recent Codex desktop logs and keybindings | Verified local app actions and local command results. Diagnostic output can contain task/control labels or paths. |
