...
const guardScript = "io.streamdex.plugin.sdPlugin/scripts/ptt-guard.mjs";
...
describe("push-to-talk dictation lease", () => {
  ...
  it("keeps the legacy AppleScript compilable and limited to key-up cleanup", () => {
    const script =
      "io.streamdex.plugin.sdPlugin/scripts/codex-control.applescript";
  ...
  it("recognizes only the visible Codex composer dictation states", () => {
    const native = ".build/test-bin/codex-ui-control";
