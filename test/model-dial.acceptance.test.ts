...
describe("model dial acceptance", () => {
  ...
  it("supports synthetic family identifiers and rejects unsafe labels", () => {
    // Fictional identifier exercises family matching, not a product roadmap.
    expect(
      supportedModelOptions({
        models: [
          {
            slug: "gpt-fixture-terra",
            display_name: "GPT-Fixture-Terra",
