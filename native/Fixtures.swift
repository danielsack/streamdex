...
func fixtureComposerSnapshot(_ scenario: String) -> NeutralComposerSnapshot {
    ...
    case "full-access", "descendant-full-access": nodes.append(fixtureNode(kAXStaticTextRole as String, "Full access", nil, parentIndex: 1))
...
func runFixtureAction(_ action: String, arguments: [String]) {
    ...
    if action == "--selection-payload-fixture" {
        ...
        switch scenario {
        case "model-future":
            // This identifier is synthetic test data, not a product or roadmap name.
            accepted = validatedModelSelection(payload("gpt-fixture-terra", "Terra")) != nil
        case "model-label-mismatch":
            accepted = validatedModelSelection(payload("gpt-fixture-terra", "Sol")) == nil
        case "model-unsafe":
            accepted = validatedModelSelection(payload("gpt-fixture-terra;open", "Terra")) == nil
